...
//            if (key[0] !== '-' && key[0]=='outputFile') {
                // We found the output path!
//            console.log(self.options.output[key]);
//                output_path = key; continue;
                output_path = self.options.output[key]; continue;
            }
    ...
    self.start = function(callback) {
        var proc = spawn('/Users/blaze/node_modules/ffmpeg-static/bin/darwin/x64/ffmpeg', self._compileOptions(self.options));
